...
export default async function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-200 py-12">
      <div className="mx-auto max-w-5xl rounded-lg border-[12px] border-blue-900 bg-[#fffdf5] p-6 shadow-2xl">
          ...
          <div className="mt-10 space-y-4 text-center text-lg">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <img
                src="/gold-badge.png"
                alt="Gold Badge"
                className="h-16 w-16 -rotate-12 drop-shadow-xl"
              />
            ...
            <p>
              <strong>Completion Date:</strong> {today}
            </p>
